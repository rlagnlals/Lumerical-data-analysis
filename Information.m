...
% Last Modified by GUIDE v2.5 20-Jan-2015 00:04:34
...
function Data_information_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Data_information (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
